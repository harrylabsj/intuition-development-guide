...
tags: intuition, decision-making, inner-wisdom, somatic-intelligence, self-trust
...
**User input:** "I overthink every decision. Teach me to access and trust my intuition."

**Expected output:** Intuition-building program — body-signal awareness training (gut feelings, tension patterns mapped to decisions), intuition-vs-fear differentiation exercises, small-decision practice protocol (start with low-stakes lunches/books, log intuitive hits vs. misses), and decision journal template.

### Scenario 2

**User input:** "In my leadership role, when should I trust gut feel vs. demand more data?"

**Expected output:** Intuition-in-leadership framework — domain-expertise check (intuition reliable where you have 10,000+ hours of pattern recognition), decision-type taxonomy (people decisions → intuition-weighted, resource allocation → data-weighted), and 'intuition stress test' questions to pressure-test gut calls before acting.

### Scenario 3

**User input:** "Create a 21-day intuition development challenge for daily practice."

**Expected output:** 21-day structured challenge — daily exercises progressing from body awareness (Days 1-7: interoception training) to environmental sensing (Days 8-14: people/place energy reading) to decision application (Days 15-21: real-choice intuition deployment), with daily reflection prompts and weekly synthesis exercises.
### Scenario 4: 不知道怎么选对象
**User input:** "同时跟两个女生在接触，一个条件很好但没感觉，一个感觉很好但条件差，直觉告诉我要选有感觉的，但理性又觉得选条件好的，怎么办？"
**Expected output:** 提供'理性-直觉整合'分析法：1）先用直觉做第一轮筛选——闭上眼睛想象和每个女生相处的5年后，你的感受如何；2）再用理性做第二层评估——列出两段关系的核心矛盾（如价值观差异、家庭背景、未来规划是否一致）；3）做'最难接受实验'——问自己：如果最坏的情况发生（维持10年），哪一边的坏结果你更愿意承受？4）建议不要被条件/感觉二选一框住——最好的选择是既有感觉又对未来有信心的人。最后提醒：不管选谁，选了就不要后悔。
